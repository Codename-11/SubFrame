/* AUTO-GENERATED — do not edit. Source: src/shared/frameTemplates.ts */
...
var backlinkUtils_exports = {};
__export(backlinkUtils_exports, {
  BACKLINK_END: () => BACKLINK_END,
  BACKLINK_START: () => BACKLINK_START,
  getBacklinkBlock: () => getBacklinkBlock,
  getBacklinkTarget: () => getBacklinkTarget,
  getClaudeNativeStatus: () => getClaudeNativeStatus,
  getNativeFileStatus: () => getNativeFileStatus,
  hasBacklink: () => hasBacklink,
  injectBacklink: () => injectBacklink,
  isSymlinkFile: () => isSymlinkFile,
  removeBacklink: () => removeBacklink,
  updateBacklink: () => updateBacklink,
  verifyBacklinks: () => verifyBacklinks,
  verifyNativeFile: () => verifyNativeFile
});
...
function getClaudeNativeStatus(projectPath) {
  ...
  try {
    ...
    status.exists = true;
    status.hasConfig = fs.existsSync(path2.join(claudeDir, "settings.json"));
    status.hasMemory = fs.existsSync(path2.join(claudeDir, "memory.md"));
    status.hasProjects = fs.existsSync(path2.join(claudeDir, "projects"));
  } catch (err) {
...
function verifyNativeFile(projectPath, filename) {
  ...
  try {
    ...
    if (status.hasBacklink) {
      ...
      if (target) {
        const targetPath = path2.join(projectPath, target);
...
var frameTemplates_exports = {};
__export(frameTemplates_exports, {
  AGENTS_TEMPLATE_VERSION: () => AGENTS_TEMPLATE_VERSION,
  SUBFRAME_MANAGED_REGEX: () => SUBFRAME_MANAGED_REGEX,
  SUBFRAME_VERSION_REGEX: () => SUBFRAME_VERSION_REGEX,
  getAgentsTemplate: () => getAgentsTemplate,
  getClaudeSettingsHooksTemplate: () => getClaudeSettingsHooksTemplate,
  getCodexWrapperTemplate: () => getCodexWrapperTemplate,
  getDefaultReviewWorkflow: () => getDefaultReviewWorkflow,
  getDocsAuditWorkflow: () => getDocsAuditWorkflow,
  getDocsInternalReadme: () => getDocsInternalReadme,
  getFrameConfigTemplate: () => getFrameConfigTemplate,
  getGenericWrapperTemplate: () => getGenericWrapperTemplate,
  getHealthCheckWorkflow: () => getHealthCheckWorkflow,
  getHookUpdaterScript: () => getHookUpdaterScript,
  getNativeFileTemplate: () => getNativeFileTemplate,
  getNotesTemplate: () => getNotesTemplate,
  getOnboardSkillTemplate: () => getOnboardSkillTemplate,
  getPostToolUseHookTemplate: () => getPostToolUseHookTemplate,
  getPreCommitHookTemplate: () => getPreCommitHookTemplate,
  getPrePushHookTemplate: () => getPrePushHookTemplate,
  getPreToolUseHookTemplate: () => getPreToolUseHookTemplate,
  getPromptSubmitHookTemplate: () => getPromptSubmitHookTemplate,
  getQuickstartTemplate: () => getQuickstartTemplate,
  getSecurityScanWorkflow: () => getSecurityScanWorkflow,
  getSessionStartHookTemplate: () => getSessionStartHookTemplate,
  getStopHookTemplate: () => getStopHookTemplate,
  getStructureTemplate: () => getStructureTemplate,
  getSubAuditSkillTemplate: () => getSubAuditSkillTemplate,
  getSubDocsSkillTemplate: () => getSubDocsSkillTemplate,
  getSubTasksSkillTemplate: () => getSubTasksSkillTemplate,
  getTaskMarkdownTemplate: () => getTaskMarkdownTemplate,
  getTaskVerifyWorkflow: () => getTaskVerifyWorkflow,
  getTasksTemplate: () => getTasksTemplate
});
module.exports = __toCommonJS(frameTemplates_exports);
...
// src/shared/frameTemplates.ts
var SUBFRAME_VERSION_REGEX = /@subframe-version\s+([\d.\-a-zA-Z]+)/;
var SUBFRAME_MANAGED_REGEX = /@subframe-managed:\s*false/;
...
function getTaskMarkdownTemplate(task) {
...
function getNativeFileTemplate() {
  const { getBacklinkBlock: getBacklinkBlock2 } = (init_backlinkUtils(), __toCommonJS(backlinkUtils_exports));
  return getBacklinkBlock2() + "\n";
}
...
function getSecurityScanWorkflow() {
  return `# @subframe-version ${FRAME_VERSION}
# @subframe-managed
name: security-scan
on:
...
0 && (module.exports = {
  ...
  SUBFRAME_MANAGED_REGEX,
  SUBFRAME_VERSION_REGEX,
  getAgentsTemplate,
  getClaudeSettingsHooksTemplate,
  getCodexWrapperTemplate,
  getDefaultReviewWorkflow,
  getDocsAuditWorkflow,
  getDocsInternalReadme,
  ...
  getTaskMarkdownTemplate,
  getTaskVerifyWorkflow,
  getTasksTemplate
});
