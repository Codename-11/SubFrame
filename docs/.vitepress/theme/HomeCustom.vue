        ...
        <div class="showcase-grid">
          <div class="showcase-card fade-in">
            <div class="showcase-image structure-map-image">
              ...
              <div class="structure-tabs">
                <button :class="{ active: structureView === 'graph' }" @click="structureView = 'graph'">Graph</button>
                <button :class="{ active: structureView === 'mindmap' }" @click="structureView = 'mindmap'">Mindmap</button>
              </div>
              ...
              <div v-show="structureView === 'graph'" class="graph-preview">
                <svg viewBox="0 0 200 130" fill="none" class="structure-svg">
                  ...
                  <!-- utils node -->
                  <circle cx="100" cy="115" r="8" fill="rgba(34,197,94,0.15)" stroke="#22c55e" stroke-width="1">
                    <animate attributeName="r" values="8;9;8" dur="3.8s" repeatCount="indefinite" />
                  </circle>
                  <text x="100" y="118" fill="#22c55e" font-size="5.5" font-family="var(--sf-font-mono)" text-anchor="middle">utils</text>
                </svg>
              </div>
              ...
              <div v-show="structureView === 'mindmap'" class="mindmap-preview">
                <svg viewBox="0 0 200 130" fill="none" class="structure-svg">
                  ...
                  <path d="M82,70 Q60,90 40,100" stroke="#22c55e" stroke-width="1" fill="none" opacity="0.5" />
                  <!-- Branch nodes -->
                  ...
                  <circle cx="35" cy="102" r="10" fill="rgba(34,197,94,0.12)" stroke="#22c55e" stroke-width="1" />
                  <text x="35" y="105" fill="#22c55e" font-size="5" font-family="var(--sf-font-mono)" text-anchor="middle">tests</text>
                </svg>
              </div>
            </div>
          ...
          <div class="showcase-card fade-in">
            <div
              ...
              style="background: linear-gradient(135deg, var(--sf-bg-card) 0%, var(--sf-bg-elevated) 100%)"
            >
              <svg viewBox="0 0 200 120" fill="none">
                ...
                <rect x="20" y="70" :width="usageWeekly * 160 / 100" height="8" rx="4" fill="#22c55e">
                ...
                <rect x="20" y="92" width="60" height="20" rx="6" fill="var(--sf-accent-subtle)" stroke="var(--sf-accent)" stroke-width="0.5" class="showcase-btn" @click="refreshUsage" style="cursor:pointer" />
          ...
          <div class="showcase-card fade-in">
            ...
            >
              <svg viewBox="0 0 200 140" fill="none">
                ...
                <!-- Row 1: Healthy -->
                <circle cx="28" cy="45" r="4" fill="#22c55e" filter="url(#health-glow-g)">
                ...
                <text x="145" y="48" fill="#22c55e" font-size="6" font-family="var(--sf-font-mono)" text-anchor="middle">Healthy</text>

                <!-- Row 2: Outdated → Healthy on update -->
                <circle cx="28" cy="70" r="4" :fill="healthFixed ? '#22c55e' : '#f59e0b'" :filter="healthFixed ? 'url(#health-glow-g)' : 'url(#health-glow-w)'">
                  <animate attributeName="r" values="4;5;4" dur="2s" repeatCount="indefinite" />
                  <animate attributeName="opacity" values="1;0.7;1" dur="2s" repeatCount="indefinite" />
                </circle>
                ...
                <text x="145" y="73" :fill="healthFixed ? '#22c55e' : '#f59e0b'" font-size="6" font-family="var(--sf-font-mono)" text-anchor="middle">{{ healthFixed ? 'Healthy' : 'Outdated' }}</text>

                <!-- Row 3: Healthy -->
                <circle cx="28" cy="95" r="4" fill="#22c55e" filter="url(#health-glow-g)">
                  <animate attributeName="r" values="4;5;4" dur="2s" repeatCount="indefinite" />
                  <animate attributeName="opacity" values="1;0.7;1" dur="2s" repeatCount="indefinite" />
                </circle>
                ...
                <text x="145" y="98" fill="#22c55e" font-size="6" font-family="var(--sf-font-mono)" text-anchor="middle">Healthy</text>

                <!-- Update button -->
                <rect x="20" y="115" width="70" height="20" rx="6" fill="var(--sf-accent-subtle)" stroke="var(--sf-accent)" stroke-width="0.5" class="showcase-btn" @click="updateHealth" style="cursor:pointer" />
          ...
          <div class="showcase-card fade-in">
            ...
            >
              <svg viewBox="0 0 200 140" fill="none">
                ...
                <text x="142" y="18" fill="#22c55e" font-size="7" font-family="var(--sf-font-mono)">active</text>
          ...
          <div class="showcase-card fade-in">
            <div class="showcase-image structure-map-image">
              <!-- Task view tabs -->
              <div class="structure-tabs">
                <button :class="{ active: taskView === 'kanban' }" @click="taskView = 'kanban'">Kanban</button>
                <button :class="{ active: taskView === 'timeline' }" @click="taskView = 'timeline'">Timeline</button>
                <button :class="{ active: taskView === 'graph' }" @click="taskView = 'graph'">Graph</button>
              </div>
              ...
              <div v-show="taskView === 'kanban'" class="kanban-preview">
                <svg viewBox="0 0 200 130" fill="none" class="structure-svg">
                  ...
                  <text x="164" y="16" fill="#22c55e" font-size="6" font-family="var(--sf-font-mono)" text-anchor="middle">Done</text>
                  <!-- Dividers -->
              ...
              <div v-show="taskView === 'timeline'" class="timeline-preview">
                <svg viewBox="0 0 200 130" fill="none" class="structure-svg">
                  ...
                  <!-- Completed task bar -->
                  <rect x="25" y="20" width="70" height="14" rx="4" fill="rgba(34,197,94,0.2)" stroke="#22c55e" stroke-width="0.5" />
                  <text x="30" y="30" fill="#22c55e" font-size="5" font-family="var(--sf-font-mono)">Init flow</text>
                  <!-- Completed task bar 2 -->
                  <rect x="50" y="40" width="55" height="14" rx="4" fill="rgba(34,197,94,0.2)" stroke="#22c55e" stroke-width="0.5" />
                  <text x="55" y="50" fill="#22c55e" font-size="5" font-family="var(--sf-font-mono)">Health panel</text>
                  <!-- In progress bar -->
              ...
              <div v-show="taskView === 'graph'" class="graph-preview">
                <svg viewBox="0 0 200 130" fill="none" class="structure-svg">
                  ...
                  <rect x="25" y="18" width="60" height="22" rx="6" fill="rgba(34,197,94,0.12)" stroke="#22c55e" stroke-width="1" />
                  <text x="55" y="32" fill="#22c55e" font-size="6" font-family="var(--sf-font-mono)" text-anchor="middle">Init flow</text>
                  ...
                  <rect x="25" y="88" width="60" height="22" rx="6" fill="rgba(34,197,94,0.12)" stroke="#22c55e" stroke-width="1" />
                  <text x="55" y="102" fill="#22c55e" font-size="6" font-family="var(--sf-font-mono)" text-anchor="middle">Health panel</text>
