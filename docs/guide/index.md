...
SubFrame is an Electron desktop application. Currently tested and released for **Windows**, with macOS and Linux builds available but untested:

| Platform | Status | Installer |
|----------|--------|-----------|
| **Windows** | Supported (Windows 10+) | `.exe` (NSIS installer) |
| **macOS** | Coming soon (untested builds available) | `.dmg` |
| **Linux** | Coming soon (untested builds available) | AppImage / `.deb` |

::: warning Platform Support
macOS and Linux builds are generated by CI but have not been tested. If you try them, please [report any issues](https://github.com/Codename-11/SubFrame/issues) — community testing helps us expand platform support.
:::
